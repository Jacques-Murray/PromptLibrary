...
PROMPT_GENERATOR = Prompt(
    ...
    description="A detailed system prompt for generating effective prompts",
...
PROMPT_EDITOR = Prompt(
    name="prompt_editor",
    category=PromptCategory.SYSTEM,
    description="A detailed system prompt for editing and improving existing prompts",
    template="""Given a current prompt and a change description, produce a detailed system prompt to guide a language model in completing the task effectively.
